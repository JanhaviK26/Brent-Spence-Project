...
class StrainAutoencoder:
    ...
    def detect_anomalies(self, data, timestamps=None):
        ...
        # Only return days with unusual patterns
        anomaly_dates = []
        ...
        # Return only the days with unusual patterns
        return {
            'anomaly_dates': sorted(list(set(anomaly_dates))),
            'total_anomaly_days': len(set(anomaly_dates))
        } 